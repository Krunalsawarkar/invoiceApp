    ...
    <div className="relative">
      ...
      >
        {avatar ? (
          ...
          <div className="h-8 w-8 bg-gradient-to-r from-[#ff822f] to-[#ff9d5b] rounded-xl flex items-center justify-center  hover:bg-[#FE7F2D] hover:shadow-lg">
            <span className="text-[#192c38] font-semibold text-sm ">
