      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#233D4D] max-w-3xl mx-auto">
            We are trusted by thousands of freelancers and small business owners
            worldwide.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {TESTIMONIALS.map((testimonial, index) => (
            ...
            >
              <div className="absolute -top-4 left-8 w-8 h-8 bg-gradient-to-br from-[#233D4D] to-[#3a5e75] rounded-full flex items-center justify-center">
